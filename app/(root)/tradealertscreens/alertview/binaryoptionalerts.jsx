        ...
        <ScrollView className="mt-8 px-3">
            ...
            <View className="flex-row justify-between items-center p-3 my-3">
                <View>
                    ...
                    <Text className="text-white font-questrial text-xl">1.18</Text>
                </View>
                <View>
                    <Text className="text-[#83838D] font-sora">TP1</Text>
                    <Text className="text-white font-questrial text-xl">1.185</Text>
                </View>
                <View>
                    <Text className="text-[#83838D] font-sora">TP2</Text>
                    <Text className="text-white font-questrial text-xl">1.19</Text>
                </View>
                <View>
                    <Text className="text-[#83838D] font-sora">TP3</Text>
                    <Text className="text-white font-questrial text-xl">1.195</Text>
                </View>
            </View>
            <View className="flex-row justify-between items-center mt-3">
                <View>
                    <Text className="text-white font-sora text-2xl">1.1825</Text>
                    <Text className="text-[#05FF92] font-sora">+0.0025</Text>
                </View>
            </View>
