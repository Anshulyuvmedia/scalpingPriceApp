// app/(root)/(tabs)/chatbot/tabview/IndexTab.jsx
...
const IndexTab = ({ signals, loading, error, onRefresh }) => {
    ...
    if (signals.length === 0) {
        return (
            <View className="flex-1 bg-black justify-center items-center">
                <Text className="text-white font-questrial text-lg">No Index signals available.</Text>
            </View>
        );
    }
